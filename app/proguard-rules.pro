...
# TOML decoder
-keep class me.zhanghai.android.files.viewer.text.LanguageRegistry$LanguageEntry { *; }
-keepclassmembers class me.zhanghai.android.files.viewer.text.LanguageRegistry$LanguageEntry { *; }
